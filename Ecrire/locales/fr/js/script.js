var sankoreLang = {
    display: "Afficher",
    edit: "Modifier",
    instruct_text1: "Exemple de consigne. Ecrire le texte correspondant à la définition.",
    instruct_text2: "Exemple de consigne. Ecrire le texte correspondant à l'image.",
    instruct_text3: "Exemple de consigne. Ecrire le texte correspondant au son.",
    input_text: "Ecrire la réponse ici",
    hint_text: "Boîte à indices. Ces indices pourront être dévoilés... ou pas.",
    ref_text1: "crocodile",
    ref_text2: "un",
    ref_text3: "bateau",
    text1: "Reptile carnivore couvert d'écailles, à pattes courtes et grandes mâchoires.",
    hint_text1: "Cet animal vit dans les eaux chaudes et peut mesurer plusieurs mètres de long.",
    hint_text2: "Ce chiffre ne contient que deux lettres.",
    hint_text3: "Attention le son 'o' que tu entends ne s'écrit pas avec la lettre 'o'.",
    new_ref_text: "Texte de reference",
    new_txt: "Nouveau bloc de texte",
    new_inst_txt: "Ceci est une nouvelle diapositive. Nouvelle consigne.",
    new_inst_txt1: "Nouvelle consigne.",
    new_hint_txt: "Ceci est une nouvelle boîte à indices.",
    wgt_name: "Ecrire",
    slate: "ardoise",
    pad: "tablette",
    none: "aucun",
    help: "Aide",
    help_content: "<p><h2>Ecrire</h2></p>"+
    "<p><h3>Livret de pages avec comparaison de texte.</h3></p>"+

    "<p>L’interactivité 'Ecrire' est un livret permettant sur chaque page d'écrire du texte (texte à écrire) et de le comparer avec un texte prédéfini (texte de référence)"+
    " en cliquant sur un bouton. Ce livret peut être enrichi avec du texte, des images, du son et des vidéos afin de donner des indices sur le texte à écrire."+
    " Des pages peuvent être ajoutées ou supprimées dans le livret. </p>"+
...
"<ul><li>écrire le texte de référence dans la zone de texte à fond vert située en haut à gauche de l’interactivité (pour modifier ces zones de texte, cliquez à l’intérieur et écrivez du texte)."+
" Ce texte n'apparaîtra pas en mode 'Afficher'.</li>"+
"<li>insérer des zones de texte pour écrire des consignes (ou des titres) avec le bouton jaune “+T” situé en haut à gauche de l’interactivité (pour modifier ces zones de texte, cliquez à l’intérieur et écrivez du texte)."+
" Ce texte apparaîtra en jaune.</li>"+
"<li>insérer des zones de texte avec le bouton gris “+T” situé en haut à gauche de l’interactivité (pour modifier ces zones de texte, cliquez à l’intérieur et écrivez du texte)."+
" Ce texte apparaîtra en noir sur fond blanc.</li>"+
"<li>insérer une zone de texte à indices (ou zone d'aide) avec le bouton jaune en forme d'ampoule situé en haut à gauche de l’interactivité."+
" Cette zone de texte sera créée avec un fond jaune et une bordure jaune. Une ampoule jaune, créée a sa droite, y sera associée."+
" En mode 'Afficher', un clic sur cette ampoule jaune fera apparaître ou disparaître cette zone de texte à indices.</li>"+
...
"<ul><li>en mode 'Afficher', le texte à écrire peut être saisi dans la zone de texte (à bord noir quand on se trouve en mode 'Modifier') située au milieu a droite de l’interactivité (pour modifier ces zones de texte, cliquez à l’intérieur et écrivez du texte),</li>"+
"<li>en cliquant sur le bouton 'vérifier' situé au milieu a droite de l’interactivité (a droite de la zone de texte contenant le texte attendu) le texte à écrire sera comparé avec le texte de référence,</li>"+
"<li>Si le texte à écrire est le même que le texte de référence, alors le fond de la zone de texte à écrire prendra la couleur verte.</li>"+
"<li>Si une ampoule jaune est présente sur votre page, un clic sur cette ampoule fera appaître ou disparaître la zone de texte a indices (boites de texte a fond et bords jaunes).</li></ul>",
    theme: "Thème"
