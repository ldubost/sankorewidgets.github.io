...
XWUZ.say = function () {
	return {
		...
		confirm: function (question) {
			XWUZ.flow.pause();
			document.getElementById('alertbox').style.display = 'block';
			document.getElementById('alertbox_content').innerHTML = question + '<br style="clear:both" /><br /><a href="#" onclick="XWUZ.say.dismiss(); XWUZ.flow.restart();return false;"><img src="i/b_okay.png" alt="Yes" /></a><a href="#" onclick="XWUZ.say.dismiss(); XWUZ.flow.resume(); return false;"><img src="i/b_no.png" alt="No" /></a>';
		},
		dismiss: function () {
	...
	return {
		...
		set: function (what) {
			...
			if (menu[what].active && what === 'game') {
				...
				XWUZ.say.confirm('<h1>Nouvelle partie</h1>Veux tu<br />redémarrer le jeu ?');
				return;
			}
