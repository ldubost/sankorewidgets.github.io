...
mindmaps.CreateNodeCommand = function() {
	...
	this.description = "Créer un nouveau noeud";
};
...
mindmaps.CreateSiblingNodeCommand = function() {
	...
	this.label = "Ajouter";
	this.icon = "ui-icon-plusthick";
	this.description = "Créer un nouveau noeud frère";
};
...
mindmaps.DeleteNodeCommand = function() {
	...
	this.description = "Supprimer un nouveau noeud";
};
...
mindmaps.EditNodeCaptionCommand = function() {
	...
	this.shortcut = "F2";
	this.label = "Modifier la légende du noeud";
	this.description = "Éditer le texte du noeud";
};
...
mindmaps.ToggleNodeFoldedCommand = function() {
	...
	this.shortcut = "space";
	this.description = "Afficher ou masquer les enfants du noeud";
};
...
mindmaps.CopyNodeCommand = function() {
	...
	this.description = "Copier une branche";
};
...
mindmaps.CutNodeCommand = function() {
	...
	this.description = "Couper une branche";
};
...
mindmaps.PasteNodeCommand = function() {
	...
	this.description = "Coller une branche";
};
...
mindmaps.NewDocumentCommand = function() {
	...
	this.description = "Commencez à travailler sur une nouvelle carte";
};
...
mindmaps.OpenDocumentCommand = function() {
	...
	this.description = "Ouvrir une carte existante";
};
...
mindmaps.SaveDocumentCommand = function() {
	...
	this.description = "Enregistrer la carte";
};
...
mindmaps.CloseDocumentCommand = function() {
	...
	this.description = "Fermer la carte";
};
...
mindmaps.HelpCommand = function() {
	...
	this.label = "Aide";
	this.shortcut = "F1";
	this.description = "Accéder à l'aide!";
};
...
mindmaps.PrintCommand = function() {
	...
	this.description = "Imprimer la carte";
};
...
mindmaps.ExportCommand = function() {
	...
	this.description = "Exporter la carte";
};
